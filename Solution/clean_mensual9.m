...
files = ["Tabla 1 - Arahuay.csv", "Tabla 2 Autisha.csv", "Tabla 3 Canchacalla.csv", ...
         "Tabla 4 Carampoma.csv", "Tabla 5 Matucana.csv", "Tabla 6 Rio Blanco.csv", ...
...
xlabel('Año');
ylabel('Precipitacióntotal mensual (mm)');

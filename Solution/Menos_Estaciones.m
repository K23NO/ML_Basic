...
all_data = join(Pre_Authisha, Pre_Canchacalla, 'Keys', {'Year', 'Month'});
...
all_data.Properties.VariableNames = {'Year', 'Month', 'Authisha', 'Canchacalla', 'Carampoma', 'Matucana', 'RioBlanco', 'SantaEula', 'SantTuna', 'Nana'};
...
X = [ones(size(all_data, 1), 1), all_data{:, {'Authisha', 'Canchacalla', 'Carampoma', 'Matucana', 'RioBlanco', 'SantaEula', 'SantTuna', 'Nana'}}];
y = all_data.Chosica;
